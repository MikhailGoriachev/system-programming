        ...
        private void TbcMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (TbcMain.SelectedIndex)
            {
                ...
                case 4:
                    ...
                    UpdateBinding(DgvSales, _controller.GetRentals());
                    break;
        ...
        private void Add_Command(object sender, EventArgs e)
        {
            switch (TbcMain.SelectedIndex)
            {
                ...
                case 4:
                    ...
                    // добавление товара в коллекцию
                    _controller.Data.Rentals.InsertOnSubmit(new CarRentalLibrary.Models.Rental());

                    // применение изменений в базе данных
                    _controller.Data.SubmitChanges();

                    UpdateBinding(DgvColors, _controller.GetRentals());
                    break;
            }
        }
        ...
        private void Edit_Command(object sender, EventArgs e)
        {
            switch (TbcMain.SelectedIndex)
            {
                ...
                case 3:
                    ...
                    CarForm formGoods = new CarForm(_controller.Data, _controller.Data.Cars.ToArray()[DgvCars.SelectedRows[0].Index]);

    ...
    public partial class MainForm : Form
    {
        ...
        private void TbcMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (TbcMain.SelectedIndex)
            {
                // 1. Числа
                case 0:
                    new Task(FillListViewNumbers).Start();
                    break;

                // 2. Ремонт ноутбуков
                case 1:
                    new Task(() => UpdateBinding(DgvNotebooks, _controller.Notebooks)).Start();
                    break;

                // 3. Словарь
                case 2:
                    new Task(UpdateDataDictionaryTab).Start();
                    break;
        ...
        private void SaveAsNotebooks_Command(object sender, EventArgs e)
        {
            ...
            // сохранение данных
            new Task(_controller.SaveNotebooks).Start();
